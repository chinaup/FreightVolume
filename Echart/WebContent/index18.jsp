<%@ page language="java" import="FreightVolume.connDB,java.util.*" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
ArrayList<String[]> list = connDB.everyTransportDeliverVolume();
%>    
    ...
    <div class="content">
        <div class="nav">
            <ul>
                ...
                <li class="current"><a href="#">A站每种运输方式发货量比例</a></li>
        ...
        <div class="container">
            <div class="title">A站每种运输方式发货量比例</div>
            <div class="show">
	    ...
	    series : [
	        {
	            ...
	            center: ['50%', '50%'],
	            data:[
                    {value:<%=list.get(0)[1]%>, name:'整车'},
                    {value:<%=list.get(1)[1]%>, name:'集装箱'},                  
